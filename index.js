...
class Speech {
     ...
     * @returns {Speech}
     */
    paragraph(paragraph, shouldEscape = true) {
     ...
     * @returns {Speech}
     */
    sentence(saying, shouldEscape = true) {
     ...
     * @returns {Speech}
     */
    spellSlowly(word, delay, shouldEscape = true) {
     ...
     * @returns {Speech}
     */
    partOfSpeech(options, shouldEscape = true) {
     ...
     * @returns {Speech}
     */
    phoneme(alphabet, ph, word, shouldEscape = true) {
     ...
     * @returns {Speech}
     */
    emphasis(level, word, shouldEscape = true) {
     ...
     * @returns {Speech}
     */
    prosody(attributes, word, shouldEscape = true) {
     ...
     * @returns {Speech}
     */
    sub(alias, word, shouldEscape = true) {
     ...
     * @returns {Speech}
     */
    sayRandomChoice(choices, shouldEscape = true) {
