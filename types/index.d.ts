...
declare class Speech {
     ...
     * @returns {Speech}
     */
    say(saying: any, shouldEscape: boolean = true): Speech;
    /**
     ...
     * @returns {Speech}
     */
    paragraph(paragraph: any, shouldEscape: boolean = true): Speech;
    /**
     ...
     * @returns {Speech}
     */
    sentence(saying: any, shouldEscape: boolean = true): Speech;
    /**
     ...
     * @returns {Speech}
     */
    spell(word: any, shouldEscape: boolean = true): Speech;
    /**
     * Creates and inserts a say-as tag.
     * see https://developer.amazon.com/public/solutions/alexa/alexa-skills-kit/docs/speech-synthesis-markup-language-ssml-reference#say-as
     ...
     * @returns {Speech}
     */
    spellSlowly(word: any, delay: any, shouldEscape: boolean = true): Speech;
    /**
     ...
     * @returns {Speech}
     */
    partOfSpeech(options: any, shouldEscape: boolean = true): Speech;
    /**
     ...
     * @returns {Speech}
     */
    phoneme(alphabet: any, ph: any, word: any, shouldEscape: boolean = true): Speech;
    /**
     ...
     * @returns {Speech}
     */
    emphasis(level: any, word: any, shouldEscape: boolean = true): Speech;
    /**
     ...
     * @returns {Speech}
     */
    prosody(attributes: any, word: any, shouldEscape: boolean = true): Speech;
    /**
     ...
     * @returns {Speech}
     */
    sub(alias: any, word: any, shouldEscape: boolean = true): Speech;
    /**
     ...
     * @returns {Speech}
     */
    sayRandomChoice(choices: any, shouldEscape: boolean = true): Speech;
}
